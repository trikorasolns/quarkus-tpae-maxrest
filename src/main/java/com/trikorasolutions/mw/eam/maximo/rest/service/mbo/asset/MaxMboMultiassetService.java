...
public interface MaxMboMultiassetService extends MaxRestCommonService {
    ...
    Uni<JsonObject> findBySiteRecordey(@QueryParam("_lid") String uid, @QueryParam("_lpwd") String pwd,
                                       @QueryParam("siteid") String siteId, @QueryParam("recordkey") String recordKey,
