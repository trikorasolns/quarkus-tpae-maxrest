...
public interface TpaeMboWorkorderService {
    ...
    @Path("/{id}")
    @Produces("application/json")
    Uni<JsonObject> getById(@QueryParam("_lid") String uid, @QueryParam("_lpwd") String pwd, @PathParam("id") String id,
                            Map<String, String> multiValueMap);

    @GET
    @Path("/")
    @Produces("application/json")
    Uni<JsonObject> getByNum(@QueryParam("_lid") String uid, @QueryParam("_lpwd") String pwd,
                             @QueryParam("wonum") String workorder, @QueryParam("siteid") String site,
                             Map<String, String> multiValueMap);
    ...
    @Path("/{id}")
    @Produces("application/json")
    Uni<JsonObject> changeStatus(@HeaderParam("x-http-method-override") String method, @PathParam("id") String id,
                                 @QueryParam("_lid") String uid, @QueryParam("_lpwd") String pwd,
